...
Tags: database, plugin, content
Requires at least: 3.2
Tested up to: 3.9
Stable tag: 0.1
License: GPLv3

Save queries run by plugins to an SQL script for deployment

== Description ==

Allows developers to record queries when setting up plugins locally, creating an SQL script that can be run later when deploying to a staging or live site.
